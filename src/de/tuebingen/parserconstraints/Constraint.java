...
public class Constraint {
    ...
    public String getName(int i) {
        ...
        switch (i) {
            case 1:
                res = arg1.length() == 0 ? "" : arg1.substring(0, arg1.length() - 2); // to remove :l or :r
                break;
            case 2:
                res = arg2.length() == 0 ? "" : arg2.substring(0, arg2.length() - 2); // to remove :l or :r
                break;
            default://skip
        }
        return res;
    ...
    public String getType(int i) {
        ...
        switch (i) {
            case 1:
                res = arg1.length() == 0 ? "" : arg1.substring(arg1.length() - 3, arg1.length());
                break;
            case 2:
                res = arg2.length() == 0 ? "" : arg2.substring(arg2.length() - 3, arg1.length());
                break;
            default://skip
        }
        return res;
